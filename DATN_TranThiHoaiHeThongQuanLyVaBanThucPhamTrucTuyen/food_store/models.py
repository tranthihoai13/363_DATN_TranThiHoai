...
class Order(db.Model):
    ...
    payment_message = db.Column(db.String(255), nullable=True)
    paid_at = db.Column(db.DateTime, nullable=True)
    vnpay_txn_ref = db.Column(db.String(100), nullable=True, index=True)
    vnpay_transaction_no = db.Column(db.String(100), nullable=True)
    vnpay_bank_code = db.Column(db.String(50), nullable=True)
    vnpay_response_code = db.Column(db.String(10), nullable=True)
    vnpay_transaction_status = db.Column(db.String(10), nullable=True)
    ...
    def payment_method_label(self):
        return self.PAYMENT_METHOD_CHOICES.get(self.payment_method, self.payment_method)

    @property
    def payment_status_label(self):
        return self.PAYMENT_STATUS_CHOICES.get(self.payment_status, self.payment_status)
